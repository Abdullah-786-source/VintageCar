...
const CustomerEdit = ({ open, setOpen, updateData, recordToEdit }) => {
  const [customer, setCustomer] = useState({ ...recordToEdit });

  useEffect(() => {
    setCustomer({ ...recordToEdit });
  }, [recordToEdit]);

  const handleSubmit = async (event) => {
    event.preventDefault();
    const response = await axios.put(
      `/EditProfile/${customer.customerNumber}`,
      customer
    );
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {/* <TextField
              ...
              disabled // You might want to disable editing the customer number
            /> */}

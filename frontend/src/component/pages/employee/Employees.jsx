...
import EditEmployee from "./EditEmployee"; // Import your EditProfile component
...
export default function DataTable() {
  ...
  const columns = [
    ...
    { field: "reportsTo", headerName: "Report To", width: 150 },
  ...
  const getRowId = (row) => row.employeeNumber;
  ...
  return (
    <Box>
      ...
      >
        ...
        <CreateEmployee open={open} setOpen={setOpen} updateData={updateData} />
        <EditEmployee
          open={editOpen}
          setOpen={setEditOpen}
